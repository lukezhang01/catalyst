...
- **Project responsibilities:** Coordinate releases and submissions. Creative design, build and test backend services, evaluate AI features. Backup Project Lead.
- **Creative role:** Prototype Builder. turn research ideas into working features and test how well they solve the problem.
- **Strengths:** Python, backend development, machine learning, performance testing, and presenting technical findings clearly.
